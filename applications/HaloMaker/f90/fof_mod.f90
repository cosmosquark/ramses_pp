module fof
  ...
  ! octtree
  type cell
     real(kind=4)    :: size                    ! half lengh of the cell
     real(kind=4)    :: pos(3)                  ! position of the center of the cell
...
! case if omega_baryons is not zero!
  ...
  fEps      = b_init*real(mass_eq,4)**(1./3.)
  fEps2     = fEps*fEps
